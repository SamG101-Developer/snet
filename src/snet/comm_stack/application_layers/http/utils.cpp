...
export namespace snet::comm_stack::layers::http {
    ...
    auto normalize_url(std::string const &url) -> std::string;
    auto domain_block_url(std::string const&url) -> bool;
}


export class snet::comm_stack::layers::http::SelectableBytesIO {
...
export class snet::comm_stack::layers::http::HttpParser {
